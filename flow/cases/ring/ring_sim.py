"""Contains the ring road simulation class."""

from flow.simulation.base import Simulation
...
class RingSimulation(Simulation):
    ...
    The road network consists of nodes at the top, bottom, left, and right
    ...
    * **resolution** : number of nodes resolution
    ...
    def __init__(self,
        ...
        """Initialize a ring simulation."""
        for p in ADDITIONAL_NET_PARAMS.keys():
            if p not in net_params.additional_params:
                raise KeyError('Simulation parameter "{}" not supplied'.format(p))

        super().__init__(name, net_params, vehicles, initial_veh_config,
                         traffic_lights)
